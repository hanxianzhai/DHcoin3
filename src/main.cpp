...
uint256 hashGenesisBlock("0x0304d3364ae6d9e6719a1074c38cbf42ede68e76731bd1f8e4cee4739dfdc480");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    {  nSubsidy = 259200 * COIN;}
    else if (nHeight < 21660)
    { nSubsidy = 60 * COIN;}
    else
    {
        nSubsidy = nSubsidy * 0.5 * pow(0.85, (nHeight-21660)/(30 * 24 * 60));
    }

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 60; // DHcoin: 3.5 days
static const int64 nTargetSpacing = 1 * 60; // DHcoin: 2.5 minutes
...
{
    // DHcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "By reading we enrich the mind, by conversation we polish it";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1395145987;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085127339;
        ...
        assert(block.hashMerkleRoot == uint256("0x74b5824fbeb431ab4bc518244c86df96910d181a835c3efd43ab88f8ea08e59f"));
